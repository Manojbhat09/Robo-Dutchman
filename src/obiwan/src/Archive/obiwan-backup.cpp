...
//     if (input_image.empty()) return return_vec;
    ...
    for (size_t j = 0; j < res.size(); j++) {
        ...
        for (size_t k = 0; k < 7; k++) {
            std::cout << p[k] << ", ";
//             return_vec.push_back((float)p[k]);
        }
        std::cout << std::endl;
        ...
        return_vec.push_back((float)class_id); //return_vec[j]
        return_vec.push_back(res[j].bbox[0]);
        return_vec.push_back(res[j].bbox[1]);
        return_vec.push_back(res[j].bbox[2]);
        return_vec.push_back(res[j].bbox[3]);
    }
...
//         std::cout << (float)*it<<"\t";
    ...
    std::cout<<"\n";
//     std::cout << localizer_data[0] << "," << localizer_data[1] << ","\
//         << localizer_data[2] << "," << localizer_data[3] << "," << localizer_data[4];
//     ss << localizer_data[0] << "," << localizer_data[1] << ","\
//         << localizer_data[2] << "," << localizer_data[3] << "," << localizer_data[4];
    out_msg.data = ss.str();
    ...
    /*
    clock_t endFrame = clock(); // Check fps
    ...
    if( clockToMilliseconds(deltaTime)>1000.0){ //every second
        ...
        fps = 1000.0/(frameRate==0?0.001:frameRate); //averageFrameTimeMilliseconds
    }
    */
...
//     if(param_debug == 1) DEBUG = 1;
    ...
    /* Adding publisher */
    pub = nh.advertise<std_msgs::String>("/localizer/target/detector", 1000);
    /* Starting CV Window */
